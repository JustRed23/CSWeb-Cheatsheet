...
public class AccountController : Controller
{
    ...
    {
        var properties = _signInManager.ConfigureExternalAuthenticationProperties("Facebook", Url.Action("ExternalResponse", "Account"));
        return new ChallengeResult("Facebook", properties);
    }
    
    public IActionResult GoogleLogin()
    {
        var properties = _signInManager.ConfigureExternalAuthenticationProperties("Google", Url.Action("ExternalResponse", "Account"));
        return new ChallengeResult("Google", properties);
    }

    public IActionResult ExternalLogin()
    {
        var properties = _signInManager.ConfigureExternalAuthenticationProperties("oidc", Url.Action("ExternalResponse", "Account"));
    ...
    {
        var userName = info.Principal.FindFirst(info.LoginProvider == "oidc" ? "name" : ClaimTypes.Name).Value;
        userName = $"{userName}_{info.LoginProvider}_{info.ProviderKey}";
        var email = info.Principal.FindFirst(info.LoginProvider == "oidc" ? "email" : ClaimTypes.Email).Value;
    ...
    {
        var user = GetIdentityUser(externalLoginInfo);
